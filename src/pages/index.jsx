...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="./fareha_hassan_cv.pdf" variant="secondary" className="group mt-6 w-full">
        Download Resume
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content=" Hi, I&apos;m Fareha Hassan, a Flutter Developer developer based in the Pakistan."
        />
      </Head>
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://twitter.com/farehahassan"
              aria-label="Follow on Twitter"
              icon={TwitterIcon}
            />
            <SocialLink
              href="https://www.instagram.com/farehadev/"
